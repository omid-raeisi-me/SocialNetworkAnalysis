...
{
    public class GetDistancesFromAllUsers : IGetDistancesFromAllUsers
    {
        private readonly IGraphRuntime _runtime;
        private readonly IDistancesFromAllUsers _distancesAlgorithm;

        public GetDistancesFromAllUsers(IGraphRuntime runtime, IDistancesFromAllUsers distancesAlgorithm)
        {
            _runtime = runtime;
