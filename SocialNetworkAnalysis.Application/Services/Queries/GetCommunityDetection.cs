...
{
    public class GetCommunityDetection : IGetCommunityDetection
    {
        private readonly IGraphRuntime _runtime;
        private readonly ICommunityDetection _communityDetectionAlgorithm;

        public GetCommunityDetection(IGraphRuntime runtime, ICommunityDetection communityDetectionAlgorithm)
        {
            _runtime = runtime;
