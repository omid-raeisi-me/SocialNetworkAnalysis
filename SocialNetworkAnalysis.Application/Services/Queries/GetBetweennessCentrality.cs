...
{
    public class GetBetweennessCentrality : IGetBetweennessCentrality
    {
        private readonly IGraphRuntime _runtime;
        private readonly IBetweennessCentrality _betweennessCentralityAlgorithm;

        public GetBetweennessCentrality(IGraphRuntime runtime, IBetweennessCentrality betweennessCentralityAlgorithm)
        {
            _runtime = runtime;
