...
{
    public class GetCommonFriendsService : IGetCommonFriendsService
    {
        private readonly IGraphRuntime _runtime;
        private readonly ICommonNeighbors _commonNeighborsAlgorithm;

        public GetCommonFriendsService(IGraphRuntime runtime, ICommonNeighbors commonNeighborsAlgorithm)
        {
            _runtime = runtime;
